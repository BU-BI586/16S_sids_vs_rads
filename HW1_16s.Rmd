...
dadaRr <- dada(derepFr, err=errFr, multithread=TRUE)
dadaRs <- dada(derepFr, err=errFr, multithread=TRUE)
dadaFr[[1]]
dadaFs[[1]]
```
...
merge
```{r}
mergerr <- mergePairs(dadaFr, filtFr, dadaRr, filtRr, verbose=TRUE)
